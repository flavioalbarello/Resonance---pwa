...
const APP_BUILD = "2026-07-21 · websearch-reliability-fix-v1";
...
async function fetchWebSearchSnapshot(query, settings) {
  ...
  const system = "Sei un modulo di ricerca web. Hai accesso al tool di ricerca web: usalo SEMPRE per rispondere a questa richiesta, senza eccezioni. Rispondi in italiano con i dati/fatti trovati, concreti e concisi (max 150 parole), citando brevemente le fonti quando rilevante.";
