  ...
  const finalize = () => {
    ...
    onComplete({
      ...
      freeform: {
        ...
        // Non ancora letto da buildPillarCtx (che oggi consuma solo motivation/context/request via
        // il resto del profilo) — è un punto di estensione futuro, non un dato che si perde: resta
        // salvato e visibile in Setup/profilo, pronto per essere agganciato quando servirà.
